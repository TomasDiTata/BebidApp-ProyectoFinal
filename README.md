...
### Cliente
* **Catálogo Público:** Visualización de productos con barra de búsqueda.
...
### Vendedor
* **Gestión de Inventario:** Modificación de productos.
* **Control de Stock:** Actualización de cantidades y precios.
